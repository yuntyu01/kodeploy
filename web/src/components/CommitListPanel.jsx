    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-md text-fg-4 hover:text-fg-1 hover:bg-[var(--line-1)] transition-colors flex items-center justify-center"
            aria-label="닫기"
          >
            ...
            return (
              ...
              >
                ...
                <div className="mt-1 flex items-center gap-2 text-[11px] text-fg-4">
                  <span style={{ fontWeight: 510, color: "var(--accent)" }}>
                    {c.sha}
                  </span>
                  <span>·</span>
                  <span>{c.author}</span>
          ...
          >
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[12px] text-fg-3 mt-0.5 truncate">
                <span style={{ color: "var(--accent)" }}>{commit.sha}</span>
                {" · "}
                {commit.author}
                {" · "}
            ...
            <a
              ...
              className="w-8 h-8 rounded-md text-fg-4 hover:text-fg-1 hover:bg-[var(--line-1)] transition-colors flex items-center justify-center shrink-0"
              title="GitHub에서 보기"
            >
                  ...
                  >
                    ...
                    <div className="mt-1 flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-md text-[11.5px] text-fg-2 hover:text-fg-1 hover:bg-[var(--line-1)] transition-colors"
                        style={{
                          fontWeight: 510,
                          border: "1px solid var(--line-3)",
                        }}
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 rounded-md text-[11.5px] text-fg-2 hover:text-fg-1 hover:bg-[var(--line-1)] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                        style={{
                          fontWeight: 510,
                          border: "1px solid var(--line-3)",
                        }}
    ...
    <div className="flex-1 min-h-0 flex flex-col">
      ...
      >
        <button
          onClick={onExport}
          disabled={!hasEnv}
          className="flex items-center gap-1.5 px-3 py-2 rounded-md text-[12.5px] text-fg-3 hover:text-fg-1 hover:bg-[var(--line-1)] transition-colors disabled:opacity-40 disabled:hover:bg-transparent"
          style={{ fontWeight: 510 }}
          title=".env 파일로 내보내기"
        >
        ...
        {error && (
          <span
            ...
            style={{ color: "var(--err-fg)", fontWeight: 510 }}
          >
            {error}
          </span>
        )}
...
function CustomDomainSection() {
  ...
  return (
    <section className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="flex items-center gap-2 min-w-0">
            <a href={`https://${domain}`} target="_blank" rel="noopener noreferrer"
               className="inline-flex items-center gap-1 text-[12.5px] text-fg-1 no-underline hover:text-[var(--brand-fg)] truncate min-w-0" style={{ fontWeight: 540 }}>
          ...
          {records.length > 0 && (
            <div className="rounded-md overflow-hidden" style={{ border: "1px solid var(--line-2)" }}>
              <div className="px-2.5 py-1.5 text-[10px] text-fg-4" style={{ background: "var(--line-1)", fontWeight: 540 }}>
                DNS에 추가하면 인증서 자동 발급
              </div>
              {records.map((r) => (
                <div key={r.key} className="flex items-start gap-2 px-2.5 py-1.5" style={{ borderTop: "1px solid var(--line-2)" }}>
                  ...
                  <div className="flex-1 min-w-0 leading-snug">
                    ...
                    <button onClick={() => copy(`${r.key}-n`, r.name)} title="이름 복사"
                      ...
                      {copied === `${r.key}-n` && <Check size={10} strokeWidth={2.5} style={{ color: "var(--accent)" }} className="shrink-0" />}
                    </button>
                    {/* 값 — 클릭하면 복사 */}
                    <button onClick={() => copy(`${r.key}-v`, r.value)} title="값 복사"
                      className="flex items-center gap-1 w-full text-left text-[11.5px] text-[var(--brand-fg)] hover:text-fg-1 transition-colors" style={{ fontWeight: 510 }}>
                      <span className="truncate">{r.value}</span>
                      {copied === `${r.key}-v` && <Check size={10} strokeWidth={2.5} style={{ color: "var(--accent)" }} className="shrink-0" />}
                    </button>
                  </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={onConnect} disabled={busy || !value.trim()}
              ...
              style={{ border: "1px solid var(--line-3)", color: "var(--brand-fg)", fontWeight: 510 }}>
              변경
            </button>
          </div>
        </div>
      ...
      {error && <div className="text-[11px]" style={{ color: "var(--err-fg-2)" }}>{error}</div>}
    </section>
  );
}
    ...
    <div className="flex-1 min-h-0 overflow-auto scroll-thin px-5 py-5 flex flex-col gap-5">
      ...
      <section className="flex flex-col gap-3.5">
        ...
        >
          ...
          >
            <Download size={16} strokeWidth={1.8} style={{ color: "var(--brand-fg)" }} />
          </div>
          <div className="flex-1 min-w-0">
          ...
          <button
            ...
            style={{ background: "rgba(129,139,224,0.16)", color: "var(--brand-fg)", fontWeight: 540 }}
        ...
        >
          ...
          <div className="flex items-center gap-3.5">
            ...
            >
              <Upload size={16} strokeWidth={1.8} style={{ color: "var(--err-fg-2)" }} />
            </div>
            <div className="flex-1 min-w-0">
              ...
              <div className="text-[11px] mt-0.5 flex items-center gap-1.5 min-w-0">
                {file ? (
                  <>
                    <span className="truncate" style={{ color: "var(--fg-1)" }}>{file.name}</span>
                    <button
                  ...
                  <span style={{ color: "var(--err-fg-2)" }}>기존 데이터 덮어쓰기</span>
                )}
              </div>
            </div>
            ...
            {!file ? (
              <label
                ...
                style={{ background: "rgba(224,129,129,0.16)", color: "var(--err-fg-2)", fontWeight: 540 }}
              ...
              <button
                ...
                style={{
                  ...
                  color: confirming ? "#fff" : "var(--err-fg-2)",
                  fontWeight: 540,
                }}
              >
                {busy
          ...
          {confirming && !busy && (
            <div className="text-[10.5px]" style={{ color: "var(--err-fg-2)" }}>
          ...
          {msg && (
            <pre
              ...
              style={{
                background: "var(--kd-bg)",
                border: "1px solid var(--line-2)",
                color: msg.kind === "ok" ? "var(--ok-fg)" : "var(--err-fg-2)",
                lineHeight: 1.5,
              }}
            >
              {msg.text}
